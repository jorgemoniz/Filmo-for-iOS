...
class HomeViewController: UIViewController {
    ...
    func style() {
        let customColor = CONSTANTES.COLORES_BASE.BLANCO_TEXTO_NAV
    ...
    func showVCNuevoComentario() {
        let nuevoPostVC = self.storyboard?.instantiateViewController(withIdentifier: "NuevoPostTableViewController") as! NuevoPostTableViewController
...
extension HomeViewController : CarbonTabSwipeNavigationDelegate {
    ...
    func carbonTabSwipeNavigation(_ carbonTabSwipeNavigation: CarbonTabSwipeNavigation, viewControllerAt index: UInt) -> UIViewController {
        switch index {
        case 0:
            return self.storyboard?.instantiateViewController(withIdentifier: "MuroSocialViewController") as! MuroSocialViewController
        default:
            return self.storyboard?.instantiateViewController(withIdentifier: "CanalSocialViewController") as! CanalSocialViewController
        }
    }
}
*/
